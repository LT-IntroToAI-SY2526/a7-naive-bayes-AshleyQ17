...
if __name__ == "__main__":
    ...
    print(b.classify('''I’m super excited for my birthday. It’s going to be the best day ever'''))
    print(b.classify('I am really excited for my concert tomorrow. I know I am going to have so much fun and sing'))
    print(b.classify('''I am nervous that I won't do well on the AP tests.  I have studied, but I don't think I'll do that well'''))
    print(b.classify('''Got this for my son for Christmas, and he loves it! The colors are also very beautiful. He's 5'4" tall, and has absolutely no problem holding and playing the guitar comfortably. This is his first guitar, and with all the things that come with the guitar, it's the perfect guitar for aspiring musicians!'''))
    print(b.classify('''This guitar is awesome. Our daughter absolutely loves it. It's heavy like an expensive guitar and very durable. Clean look and sound quality is awesome. The amp is also nice and small making it easy for transport.'''))
    print(b.classify('''It's theft and it's fake, especially don't buy 95 for a horrible creature except they put a photo of a complete pack and in addition of poor quality it's shameful and should be avoided at all costs.'''))
    print(b.classify('''My brother and I try to activate the phone through Metro pcs. We couldn’t activate it because the seller lied stating it was unlock but the agent told us it’s not unlock its lock. I was not happy at all.
'''))
